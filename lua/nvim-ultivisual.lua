...
local delimiter_utils = require("nvim-ultivisual.utils.delimiter")
...
function M.setup(opt)
  ...
  if configs.features.delimiter == true then
    delimiter_utils.set_keymaps(configs.keymaps.delimiter)
  end
